...
var province_9_2 = echarts.init(document.getElementById('province_9_2'));
...
//存储切换的每一级地图信息
var mapStack_province_9_2 = [];
var timeFn_province_9_2 = null;
var curMap_province_9_2 = {};
//初始化地图
loadMap_province_9_2('620000', '甘肃省');
/*  各城市对应的json编号
    "兰州市": "620100",
    "嘉峪关市": "620200",
    "金昌市": "620300",
 ...
 */
function loadMap_province_9_2(mapCode, mapName) {
    $.getJSON('china-main-city/' + mapCode + '.json', function (data) {
        if (data) {
            echarts.registerMap(mapName, data);
            var option_province_9_2 = {
                tooltip : {
                    trigger: 'item',
                    formatter: '{b}',
                    itemSize:'14px',
            ...
            province_9_2.setOption(option_province_9_2);
            curMap_province_9_2 = {
                mapCode: mapCode,
                mapName: mapName
            };
